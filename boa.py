...
class ExpectedCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(
            pos_start, pos_end, "Expected Character.", details
        )
...
class RTError(Error):
    def __init__(self, pos_start, pos_end, details, context):
        super().__init__(
            pos_start, pos_end, "Runtime Error.", details
        )
...
class Parser:
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expected 'RETURN', 'CONTINUE', 'BREAK', 'VAR', 'IF', 'FOR', 'WHILE', 'FNC', int, float, identifier, '+', '-', '(', '[' or 'NOT'",
                )
            )
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expected int, float, identifier, '+', '-', '(', '[', 'IF', 'FOR', 'WHILE', 'FNC' or 'NOT'",
                )
            )
    ...
    def func_def(self):
        ...
        if not self.current_tok.matches(TT_KEYWORD, "FNC"):
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
...
global_symbol_table.set("nll", Number.null)
global_symbol_table.set("fl", Number.false)
global_symbol_table.set("true", Number.true)
global_symbol_table.set("m_pi", Number.math_PI)
global_symbol_table.set("p", BuiltInFunction.print)
global_symbol_table.set("p_ret", BuiltInFunction.print_ret)
global_symbol_table.set("inpt", BuiltInFunction.input)
global_symbol_table.set("inpt_int", BuiltInFunction.input_int)
...
global_symbol_table.set("is_fnc", BuiltInFunction.is_function)
global_symbol_table.set("append", BuiltInFunction.append)
global_symbol_table.set("pop", BuiltInFunction.pop)
global_symbol_table.set("extnd", BuiltInFunction.extend)
